...
class Appointment(tk.Toplevel):
    ...
    def create_widgets(self):
        ...
        print("Available dates:", dates)  # Debug: Print available dates
        ...
        print("Available times:", times)  # Debug: Print available times
    ...
    def close_scheduler(self):
        self.destroy()  # This will close the AppointmentScheduler window
        self.deiconify()  # This will show the main HealthHub window again
